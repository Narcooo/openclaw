...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.web.search.openai.apiKey": "OpenAI Search API Key", // pragma: allowlist secret
  "tools.web.search.openai.baseUrl": "OpenAI Search Base URL",
  "tools.web.search.openai.model": "OpenAI Search Model",
  "tools.web.search.openai.tool": "OpenAI Search Tool",
  "tools.web.search.openai.includeSources": "Include OpenAI Search Sources",
